...
- **No background scheduler yet** in v1 — there's no cron job running briefings or syncing. Everything happens on demand when you load a page. Background jobs are tracked in `PLAN.md`.
